                                ...
                                <section className='checkout'>
                                    <div className='finishOrder'>
                                        ...
                                        <span>
                                            ...
                                            (modos de envio PAC ou Sedex pelos Correios)
                                            são formas de envio com valor mais alto,
                                            status atualizado ao longo do envio porém
                                            limitadas a um único produto, logo se você
                                            selecionou mais de um produto essa forma de
                                            envio não está disponível. As entregas por
                                            Impresso Módico são formas de envio mais baratas
                                            e a única disponível para envios com mais de um produto,
                                            também feito pelos Correios com valor fixo de R$ 15,00
                                            para as regiões <strong>Norte e Nordeste</strong>, e R$ 20,00 para as
                                            regiões <strong>Sul, Sudeste e Centro-Oeste.</strong> Além disso o
                                            envio não é atualizado a todo momento: somente
                                            quando é postado na agência, chegou na sua
                                        ...
                                        <div 
                                            ...
                                            <span>
                                            <strong>
                                                Pagamento por cartão:</strong> ao selecionar o pagamento por
                                                cartão o seu pedido aparecerá na nossa lista de pedidos!
                                                Para concluir o pagamento enviaremos um link pelo WhatsApp
                                                para que você conclua a compra. Por isso aguarde
                                                para que entremos em contato ;)
                                            </span>
                                        </div>
                                        <div
