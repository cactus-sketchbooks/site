...
import MANDACARU_TAMANHOS_E_ORIENTACOES from '../../../images/MANDACARU_TAMANHOS_E_ORIENTACOES.jpg';
import BAIAO_TAMANHOS_E_ORIENTACOES from '../../../images/BAIAO_TAMANHOS_E_ORIENTACOES.jpg';
import CARCARA_TAMANHOS_E_ORIENTACOES from '../../../images/CARCARA_TAMANHOS_E_ORIENTACOES.jpg';
import FACHEIRO_TAMANHOS_E_ORIENTACOES from '../../../images/FACHEIRO_TAMANHOS_E_ORIENTACOES.jpg';
...
export default function Mescla() {
            ...
            <section id='CreateSketchbookSection'>
                    ...
                    <div className='textWrapper'>
                        ...
                        {selectedSketchModel ? (
                            selectedSketchModel === 'Mandacaru' ? (
                                <img
                                    src={MANDACARU_TAMANHOS_E_ORIENTACOES}
                                ...
                                <img
                                    src={FACHEIRO_TAMANHOS_E_ORIENTACOES}
                ...
                <div className='steps step3 full hide'>
                    <div className='textWrapper'>
                        ...
                        <img
                            src={PAPEIS_DO_MIOLO}
                            alt='Imagem mostrando os diferentes tipos de papeis que podem ser incluídos no sketchbook'
                        />
                    </div>
                ...
                <div className='steps step4 full hide'>
                    {selectedSketchModel ? (
                            ...
                            <div className='textWrapper'>
                                ...
                                {selectedSketchModel === 'Carcará' ? (
                                    <p>
                                        ...
                                        Arraste para o lado para conferir todas
                                        as opções.{' '}
                                        <button
                                            onClick={() => handleModalInfos()}
                                        >
                                    ...
                                    <>
                                        <p>
                                            Selecione <strong>até duas</strong>{' '}
                                            cores. Arraste para o lado para
                                            conferir todas as opções.{' '}
                                            <button
                                                onClick={() =>
                                                    handleModalInfos()
                                                }
                                        ...
                                        <p>
                                            ...
                                            referente à parte maior (inferior) e
                                            a <b>segunda</b> é referente à parte
                                            menor (superior). Não é possível
                                            escolher dois tipos de tecido por
                                            capa, e se um tecido for esolhido,
                                            ele <b>obrigatoriamente</b> ficará
                        ...
                        <div className='textWrapper'>
                            ...
                            <br />
                            <p>
                                Selecione primeiramente o modelo para apresentar
                                as capas disponíveis.
                            </p>
                        </div>
                    )}
                </div>
                    ...
                    {selectedSketchModel ? (
                        ...
                        selectedSketchModel === 'Baião' ? (
                            ...
                            <div className='textWrapper'>
                                ...
                                <p>
                                    O {selectedSketchModel} não permite escolha
                                    de cor da linha, avance para a próxima
                                    etapa.
                                </p>
                            </div>
                        )
                ...
                <div className='steps step6 full hide'>
                    {selectedSketchModel ? (
                        ...
                        <div className='textWrapper'>
                            ...
                            <p>
                                Selecione primeiramente o modelo para apresentar
                                as cores de elástico disponíveis.
                            </p>
                        </div>
                    )}
                </div>
